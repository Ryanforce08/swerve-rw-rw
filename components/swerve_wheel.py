...
class SwerveWheel:
    ...
    def setup(self) -> None:
        ...
        direction_motion_magic_configs.motion_magic_cruise_velocity = (
            80  # Target cruise velocity of 80 rps
        )
        direction_motion_magic_configs.motion_magic_acceleration = (
            160  # Target acceleration of 160 rps/s (0.5 seconds)
        )
        direction_motion_magic_configs.motion_magic_jerk = (
       ...
       # )
       # self.speed_motor.configSelectedFeedbackSensor(
       #     FeedbackDevice.IntegratedSensor, 0, ktimeoutMs
       # )
       ...
       # self.speed_motor.setSelectedSensorPosition(0.0, kPIDLoopIdx, ktimeoutMs)
        ...
        self.speed_talonfx_configs.motor_output.inverted
        ...
        #self.cancoder.configSensorInitializationStrategy(
        #    SensorInitializationStrategy.BootToAbsolutePosition, ktimeoutMs
        #)
